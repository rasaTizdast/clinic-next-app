...
export function ServicesPreview() {
  ...
  return (
    <section className="py-24 sm:py-32 lg:py-40 bg-background relative overflow-hidden border-y border-border/20">
      {/* Decorative gradient */}
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12 relative">
        ...
        <ScrollReveal delay={featuredServices.length * 80}>
          <div className="text-center mt-14">
            <Link
              href="/services"
              className="inline-flex items-center gap-3 text-foreground/60 font-semibold hover:text-primary transition-colors duration-200 group text-base"
            >
